...
/**
 * Command: /kill1
 * Manually registers a kill for Player 1 (for testing/admin).
 */
public class Kill1Command extends AbstractPlayerCommand {

    private final GameManager gameManager;

    public Kill1Command(GameManager gameManager) {
        super("kill1", "Register a kill for Player 1");
    ...
    protected void execute(@Nonnull CommandContext commandContext,
        ...
        boolean matchEnded = gameManager.registerKill("1");
        ...
        if (matchEnded) {
            ...
            player.sendMessage(Message.raw("§a+1 " + p1 + "! §7Score: §f" + s1 + " - " + s2));
        }
    }
}
